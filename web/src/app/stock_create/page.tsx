...
export default function CreatePage() {
    ...
    const validateThreshold = (value: string) => {
        const thresholdErrors = runValidationAll(value, [rules.required, rules.noLeadingSpace, rules.noFullWidthCharacters]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const thresholdErrors = runValidationAll(threshold, [rules.required, rules.noLeadingSpace, rules.noFullWidthCharacters]);
        setErrors({
            name: nameErrors,
